...
const RegisterCardSmall = ({ text }: RegisterCardProps) => {
  return (
    <div className='flex items-center justify-center gap-2.5 bg-white rounded-xl px-[71px] py-4 border border-[#eaecef]'>
